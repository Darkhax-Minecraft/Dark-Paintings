...
dependencies {
    // NeoForge
    implementation group: 'net.darkhax.darkpaintings', name: 'darkpaintings-neoforge-1.21.10', version: '21.10.0'

    // Forge
    implementation group: 'net.darkhax.darkpaintings', name: 'darkpaintings-forge-1.21.10', version: '21.10.0'

    // Fabric & Quilt
    modImplementation group: 'net.darkhax.darkpaintings', name: 'darkpaintings-fabric-1.21.10', version: '21.10.0'

    // Common / MultiLoader / Vanilla
    compileOnly group: 'net.darkhax.darkpaintings', name: 'darkpaintings-common-1.21.10', version: '21.10.0'
}
```
<!-- maven-end -->
